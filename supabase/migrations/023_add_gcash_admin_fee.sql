-- GCash fee: ₱15 per transaction (online/GCash payments). Walk-in = 0.
-- Admin fee: ₱15 per passenger (all bookings).
...
COMMENT ON COLUMN bookings.admin_fee_cents IS 'Admin fee in centavos (₱15 per passenger).';
