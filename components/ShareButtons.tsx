    ...
    <div className={compact ? "space-y-2" : "space-y-3"}>
      ...
      <div className="flex flex-wrap gap-2">
        ...
        <a
          ...
          title="Opens Messenger app on mobile"
        >
          <svg className={compact ? "h-3.5 w-3.5" : "h-4 w-4"} fill="currentColor" viewBox="0 0 24 24">
          ...
          <span>{compact ? "MSG" : "Messenger"}</span>
        </a>
        ...
        <a
          ...
          title="Opens Viber app on mobile"
        >
          <svg className={compact ? "h-3.5 w-3.5" : "h-4 w-4"} fill="currentColor" viewBox="0 0 24 24">
      ...
      <p className="text-xs text-[#9ca3af]">
        💡 Viber & Messenger links open on mobile devices only.
      </p>
