        ...
        <div className="p-4">
          ...
          {result ? (
            <div className="rounded-xl border border-teal-200 bg-teal-50/50 p-4">
              ...
              <button type="button" onClick={onClose} className="mt-2 w-full rounded-xl border border-[#0c7b93] px-4 py-2 text-sm font-medium text-[#0c7b93] hover:bg-[#0c7b93]/10">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex gap-3 pt-2">
                ...
                <button type="submit" disabled={submitting || totalPassengers < 1} className="flex-1 rounded-xl bg-[#0c7b93] px-4 py-3 text-sm font-semibold text-white hover:bg-[#0f766e] disabled:opacity-50">
