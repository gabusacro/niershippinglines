    ...
    const inner = (
      ...
      >
        ...
        <div
          ...
          style={{
            background: ad.image_url
              ? "linear-gradient(to bottom,rgba(0,0,0,0) 30%,rgba(4,52,44,0.92) 100%)"
              : undefined,
          }}
        />
        <div
          className={`${ad.image_url ? "absolute bottom-0 left-0 right-0" : ""} p-4`}
        >
          <p className="text-[9px] uppercase tracking-widest text-white/40 font-semibold mb-1">
            Sponsored
          </p>
          {ad.title && (
            <p className="text-[13px] font-black text-white leading-snug mb-1">
              {ad.title}
            </p>
          )}
          {ad.description && (
            <p className="text-[11px] text-white/65 font-medium mb-2 line-clamp-2">
              {ad.description}
            </p>
          )}
          <span className="inline-flex items-center gap-1 text-[10px] font-bold text-[#5DCAA5]">
            Learn more →
          </span>
        </div>
      </div>
          ...
          >
            ...
            >
              <svg
                ...
                fill="none" stroke="#0c7b93" strokeWidth="2"
            ...
            {/* Card 2 — Get here → /tours  ✅ CSS hover only */}
            <a
              href="/tours"
              className="block rounded-2xl border border-[#E5E7EB] bg-white hover:border-[#0c7b93] hover:shadow-[0_4px_24px_rgba(12,123,147,0.15)] transition-all"
              style={{
                padding: "16px 12px",
                textAlign: "center",
                boxShadow: "0 4px 24px rgba(0,0,0,0.07)",
            ...
            {/* Card 3 — Ferry → /book  ✅ CSS hover only */}
            <a
              href="/book"
              className="block rounded-2xl border border-[#E5E7EB] bg-white hover:border-[#0c7b93] hover:shadow-[0_4px_24px_rgba(12,123,147,0.15)] transition-all"
              style={{
