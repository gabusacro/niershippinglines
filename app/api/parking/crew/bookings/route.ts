...
export async function GET(request: NextRequest) {
  ...
  let query = supabase
    ...
    .select("id, reference, status, park_date_start, park_date_end, total_days, vehicle_count, vehicles, customer_full_name, lot_snapshot_name, checked_in_at, checked_out_at, created_at, payment_proof_path, gcash_transaction_reference, total_amount_cents, parking_fee_cents, platform_fee_cents, processing_fee_cents")
    .in("lot_id", lotIds)
